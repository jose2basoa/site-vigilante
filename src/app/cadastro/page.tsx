...
export default function CadastroPage() {
  ...
  const handleOAuthSignup = async (provider: 'google' | 'github') => {
    try {
      ...
      setError(err.message || `Erro ao cadastrar com ${provider}`)
      setLoading(false)
    }
  }
          ...
          <CardContent>
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <p className="text-xs text-gray-500 text-center">
                ...
                <Link href="/termos-de-uso" className="text-blue-400 hover:text-blue-300">
                  Termos de Uso
                </Link>{' '}
                e{' '}
                <Link href="/politica-de-privacidade" className="text-blue-400 hover:text-blue-300">
